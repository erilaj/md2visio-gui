...
namespace md2visio.struc.er
{
    /// <summary>
    /// ER diagram builder
    /// Builds an ErDiagram data structure from the state sequence
    /// </summary>
    internal class ErBuilder : FigureBuilder
    {
        ...
        void BuildKeyword()
        {
            ...
            {
                case "erDiagram":
                    // Mark as processed to avoid duplicate detection by FigureBuilderFactory
        ...
        void BuildWord()
        {
            ...
            // If there is a pending relationship symbol, this word is the target entity
            if (!string.IsNullOrEmpty(pendingRelationSymbol))
            {
                ...
                pendingEntityId = word; // Update to target entity for possible subsequent relationships
            }
            else
            {
        ...
        void BuildLabel()
        {
            ...
            // Apply label to the last relationship
