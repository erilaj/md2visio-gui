...
namespace md2visio.struc.sequence
{
    internal class SeqActivation
    {
        ...
        public int NestingLevel { get; set; } = 0; // Supports nested activations

        public double Height => StartY - EndY; // Note: Y axis decreases downward
        ...
        public SeqActivation(string participantId, double startY)
        {
            ...
            StartY = startY;
            EndY = startY; // Initially, end position equals start position
        }
