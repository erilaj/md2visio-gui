...
{
    /// <summary>
    /// ER diagram entity body parse state class
    /// Parses attribute definitions inside { ... } blocks
    ...
    internal class ErSttEntityBody : SynState
    {
        ...
        /// <summary>
        /// Parse the attribute list in the entity body
        /// </summary>
        public static List<(string type, string name, string keys, string comment)> ParseAttributes(string body)
        {
            ...
            foreach (var line in lines)
            {
                ...
                {
                    // Attempt simple parse (only type name)
