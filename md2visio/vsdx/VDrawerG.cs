...
namespace md2visio.vsdx
{
    ...
    internal class VDrawerG : VFigureDrawer<Graph>
    {
        ...
        public override void Draw()
        {
            ...
            PauseForViewing(300); // Give the user time to see the initial state
            
            DrawNodes(figure);
            PauseForViewing(500); // Pause after node drawing completes
            
            DrawEdges(figure);
            PauseForViewing(300); // Pause after edge drawing completes
        }        
        ...
        void DrawNodes(Graph graph)
        {
            ...
            // border - directly check whether the current graph is a subgraph
        ...
        void DrawLinkedNodes(LinkedList<GNode> nodes, GrowthDirection direct)
        {
            ...
            // 2. Calculate subtree widths (post-order traversal)
            ...
            // Traverse BFS list in reverse to achieve post-order
            ...
            void PlaceTree(GNode node, double crossCenter, double mainPos)
            {
                ...
                foreach (var child in children)
                {
                    ...
                    // Calculate next layer position by growth direction
        ...
        void DrawEdges(Graph graph)
        {
            ...
            foreach (INode node in graph.NodeDict.Values)
            {
                ...
                foreach (GEdge edge in node.OutputEdges)
                {
                    ...
                    drawnEdges.Add(edge);
                    PauseForViewing(100); // Pause after each edge is drawn
                }
            }
        }
